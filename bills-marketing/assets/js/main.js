(function () {
    ...
    window.onscroll = function () {
        ...
        if (window.pageYOffset > sticky) { header_navbar.classList.add("sticky"); logo.src = 'assets/images/logo/nutz-logo-black.svg'; } else { header_navbar.classList.remove("sticky"); logo.src = 'assets/images/logo/nutz-logo-white.svg'; }
